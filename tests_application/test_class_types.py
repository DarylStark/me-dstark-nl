...
class TestClassTypes:
    ...
    @classes(classes = [ MeException, MeExceptionPermissionDeniedException, MeExceptionPageNotFoundException, MeExceptionServerErrorException,
                         ...
                         MeAPINotesParentTagNotValidException, MeAPINotesNoTagException, MeAPIAddNotesTagDuplicateNameException, MeAPIDeleteNotesTagInvalidTagException,
                         MeAPIRenameNotesTagInvalidTagExceptionalueException, MeAPIGetNoteNoNoteExeption, MeAPIGetNoteInvalidNoteExeption, MeAPIGetNoteInvalidRevisionExeption ])
