...
class Me:
    ...
    def show_page(path):
        ...
        except (MeAPIGroupNotRegisteredException, MeAPINoAPIGroupException, MeAPIEndPointInvalidException, MeAPINoEndPointException, MePageNotFoundException, MeAPITemplatesTemplateNotFoundException, MeAPINotesParentTagNotValidException, MeAPINotesNoTagException) as error:
